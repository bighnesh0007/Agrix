...
export default function PotatoDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error("Failed to detect maize disease");
            }
            ...
            setError("Failed to detect maize disease. Please try again.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold mb-6">maize Disease Detection</h1>
