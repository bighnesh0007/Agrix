...
export default function RiceDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error("Failed to detect sugarcane disease");
            }
            ...
            setError("Failed to detect sugarcane disease. Please try again.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold mb-6">sugarcane Disease Detection</h1>
